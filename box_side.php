<div class="box side">
    ...
    <i>Type part of the title and then search</i>
    ...
    <form method="post" action="title_search.php" enctype="multipart/form-data">
        ...
        <!-- Search Button -->
        <input class="submit" type="sumbit" name="find_title" value="Search" />
...
<hr />
    ...
    <form method="post" action="vegetarian_search.php" enctype="multipart/form-data">
        ...
        <!-- Search Button -->
        <input class="submit" type="sumbit" name="find_vegetarian" value="Search" />
...
<hr />
    ...
    <form method="post" action="meal_search.php" enctype="multipart/form-data">
        ...
        <!-- Search Button -->
        <input class="submit" type="sumbit" name="find_meal" value="Search" />
...
<hr />
    ...
    <form method="post" action="location_search.php" enctype="multipart/form-data">
        ...
        <!-- Search Button -->    
        <input class="submit" type="sumbit" name="find_location" value="Search" />
...
<form method="post" action="rating_search.php" enctype="multipart/form-data">
    ...
    <select class="half_width" name="amount">
        ...
        <option value="more">At most...</option>
    </select>
